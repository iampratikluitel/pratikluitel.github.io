...
import { Users, BookOpen, Coffee, Heart, Lightbulb, Globe, Mail, Phone, Trophy, Gamepad2 } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
            ...
            <div className="bg-manga-red/10 p-6 rounded-lg border-2 border-manga-red">
              ...
              <div className="space-y-2 font-manga text-sm">
                ...
                <p className="flex items-center gap-2">
                  ...
                  <strong>GitHub:</strong> <a href="https://github.com/iampratikluitel" className="hover:underline" target="_blank" rel="noopener noreferrer">@iampratikluitel</a>
                </p>
              </div>
            </div>
      ...
      <p className="flex items-start gap-2">
        <Trophy size={16} className="mt-0.5 flex-shrink-0" /> Analyzing 3rd division Norwegian football league <em className="text-xs"></em>
      </p>
      <p className="flex items-center gap-2">
