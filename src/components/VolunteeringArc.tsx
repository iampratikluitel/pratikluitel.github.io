...
import { Users, BookOpen, Coffee, Heart, Globe, Mail, Phone, Trophy, Gamepad2, Leaf, Film, Smartphone, Link2, Mic } from "lucide-react";
...
const VolunteeringArc = () => {
  return (
    <div className="space-y-8">
      ...
      <MangaPanel className="p-8">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-green-100 p-6 rounded-lg border-2 border-green-500">
            ...
            <h5 className="font-manga text-md text-green-700 mb-1">
              Kalpabriksha Nepal, Kathmandu
            </h5>
            <p className="font-manga text-xs text-green-600 mb-3">June 2021 – Present</p>
            <ul className="list-none space-y-2 font-manga text-sm">
              <li className="flex items-start gap-2"><Leaf className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" /> Organized awareness campaigns and educational workshops for youth initiatives.</li>
              <li className="flex items-start gap-2"><Film className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" /> Developed educational multimedia presentations and workshops.</li>
              <li className="flex items-start gap-2"><Smartphone className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" /> Managed social media outreach to promote community programs.</li>
            </ul>
          ...
          {/* Blockchain Community Nepal Card */}
          <div className="bg-blue-100 p-6 rounded-lg border-2 border-blue-500">
            ...
            <h5 className="font-manga text-md text-blue-700 mb-1">
              Blockchain Community Nepal
            </h5>
            <p className="font-manga text-xs text-blue-600 mb-3">June 2023 – Jul 2023</p>
            <ul className="list-none space-y-2 font-manga text-sm">
              <li className="flex items-start gap-2"><Link2 className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" /> Organized blockchain technology sessions at colleges across Kathmandu.</li>
              <li className="flex items-start gap-2"><Mic className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" /> Hosted industry expert seminars to bridge academia and the crypto ecosystem.</li>
            </ul>
            <div className="power-level mt-4 text-xs bg-blue-600 text-white px-2 py-1 inline-block">
              CHAIN HERALD
            </div>
          </div>
        </div>
      ...
      <MangaPanel className="p-8">
        <h3 className="font-manga-title text-3xl text-center mb-8 text-manga-ink flex items-center justify-center gap-3">
          <BookOpen className="w-8 h-8 text-manga-red" />
          Scrolls of Obsessions
        </h3>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-purple-100 p-5 rounded-lg border-2 border-purple-400 text-center space-y-3">
            ...
            <div className="power-level text-xs bg-purple-600 text-white px-2 py-1 inline-block">
              LORE SEEKER
            </div>
          </div>

          <div className="bg-yellow-100 p-5 rounded-lg border-2 border-yellow-400 text-center space-y-3">
            <Trophy className="w-10 h-10 text-yellow-600 mx-auto" />
            <h4 className="font-manga-title text-lg text-yellow-800">FC Barcelona</h4>
            <p className="font-manga text-sm text-yellow-700">
              Screams <em>"Visca Barca!"</em> at unholy decibels. Maintains the heretical
              belief that <strong>Lionel Messi</strong> is football's answer to haiku.
            </p>
            <div className="power-level text-xs bg-yellow-500 text-white px-2 py-1 inline-block">
              CULE FOR LIFE
            </div>
          </div>

          <div className="bg-orange-100 p-5 rounded-lg border-2 border-orange-400 text-center space-y-3">
            <Gamepad2 className="w-10 h-10 text-orange-600 mx-auto" />
            <h4 className="font-manga-title text-lg text-orange-800">Gaming & More</h4>
            <p className="font-manga text-sm text-orange-700">
              Gaming companion when time permits. Also found analyzing 3rd-division
              Norwegian football at 2 AM for no justifiable reason.
            </p>
            <div className="power-level text-xs bg-orange-500 text-white px-2 py-1 inline-block">
              SIDE QUEST ADDICT
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-manga-red/10 p-6 rounded-lg border-2 border-manga-red">
              ...
              <div className="space-y-2 font-manga text-sm">
                ...
                <p className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-manga-red" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.761 0 5-2.239 5-5v-14c0-2.761-2.239-5-5-5zm-11 19h-3v-10h3v10zm-1.5-11.268c-.966 0-1.75-.784-1.75-1.75s.784-1.75 1.75-1.75 1.75.784 1.75 1.75-.784 1.75-1.75 1.75zm15.5 11.268h-3v-5.604c0-1.337-.026-3.063-1.868-3.063-1.868 0-2.154 1.459-2.154 2.967v5.7h-3v-10h2.881v1.367h.041c.401-.761 1.379-1.563 2.841-1.563 3.039 0 3.6 2.001 3.6 4.601v5.595zm0 0" />
                  </svg>
                ...
                <p className="flex items-center gap-2">
                  ...
                  <a href="https://github.com/iampratikluitel" className="hover:underline" target="_blank" rel="noopener noreferrer">
                    @iampratikluitel
                  </a>
                </p>
                <p className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-manga-red" fill="currentColor" viewBox="0 0 448 512">
