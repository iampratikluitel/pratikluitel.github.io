    ...
    <div className="space-y-8">
      ...
      <MangaPanel variant="dramatic" className="p-8">
        ...
        <div className="text-center mb-6">
          <div className="sound-effect text-3xl text-manga-red mb-4">TO BE CONTINUED...</div>
          <SpeechBubble>
            <p className="text-lg font-manga">
              In which our protagonist realizes that the <strong>real treasure</strong> was the 
              community he built along the way (and also the manga collection he definitely didn't spend too much money on).
            </p>
          </SpeechBubble>
        </div>
      </MangaPanel>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-green-100 p-6 rounded-lg border-2 border-green-500">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="font-manga-title text-lg text-green-800">Executive Member</h4>
            </div>
            <h5 className="font-manga text-md text-green-700 mb-2">Kalpabriksha Nepal, Kathmandu</h5>
            <ul className="list-none space-y-2 font-manga text-sm">
              <li>🌱 Organized school campaigns to raise awareness of social issues.</li>
              <li>🎬 Developed educational multimedia presentations and workshops.</li>
      ...
      <div className="space-y-6">
            {/* Interests Section */}
            <h4 className="font-manga-title text-lg text-manga-red mb-2">Scrolls of Obsessions</h4>
            <SpeechBubble>
              <p className="font-manga text-sm">
                • Devours dark manga like <em>Monster</em>, <em>Berserk</em>, and <em>Vagabond</em>—because regular narratives aren’t existential enough.<br/>
                • Cries “<em>Visca&nbsp;Barça!</em>” at unholy decibels every time <strong>FC Barcelona</strong> scores.<br/>
                • Maintains the heretical belief that <strong>Lionel Messi</strong> is football’s answer to haiku.
              </p>
            </SpeechBubble>
          </div>
      {/* Current Status */}
      <MangaPanel variant="action" className="p-8">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center space-y-4">
            ...
            <SpeechBubble className="text-sm">
              <p className="font-manga">
                - Finish final year project<br/>
                - Master new technologies<br/>
                - Consume optimal amount of coffee<br/>
                - Debug life.exe
              </p>
            </SpeechBubble>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <SpeechBubble className="text-sm">
              <p className="font-manga">
                - Join a tech company<br/>
                - Build world-changing apps<br/>
                - Maybe learn to cook<br/>
          ...
          <div className="text-center space-y-4">
            ...
            <SpeechBubble className="text-sm">
              <p className="font-manga">
                - Make technology accessible<br/>
                - Mentor the next generation<br/>
                - Complete manga collection<br/>
        ...
        <div className="text-center space-y-6">
          <SpeechBubble>
            <p className="font-manga text-lg">
              Ready to embark on the next chapter of this epic journey? 
              Whether you want to collaborate on projects, discuss the latest in AI, 
              or debate which anime has the best plot twists, let's connect!
            </p>
          </SpeechBubble>

          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-manga-red/10 p-6 rounded-lg border-2 border-manga-red">
              <h4 className="font-manga-title text-lg text-manga-red mb-4">Professional Mode</h4>
              <div className="space-y-2 font-manga text-sm">
                <p>📧 <strong>Email:</strong> pratikluitel11@gmail.com</p>
                <p>📱 <strong>Phone:</strong> +977 9840761001</p>
                <p>💼 <strong>LinkedIn:</strong> /in/pratikluitel</p>
                <p>💻 <strong>GitHub:</strong> @pratikluitel</p>
              </div>
            </div>

            <div className="bg-manga-ink/5 p-6 rounded-lg border-2 border-manga-ink">
              <h4 className="font-manga-title text-lg text-manga-ink mb-4">Casual Mode</h4>
              <div className="space-y-2 font-manga text-sm">
          ...
          <div className="power-level text-center">
            <span className="font-manga-title text-lg">STATUS: AVAILABLE FOR EPIC COLLABORATIONS</span>
          </div>
        </div>
      </MangaPanel>
      ...
      <MangaPanel variant="dramatic" className="p-8 text-center">
        ...
        <SpeechBubble className="mb-6">
          ...
          "It’s not the end, we’re just the shadow of a cloud passing over the void, and the universe is still busy turning its existential children into a black hole."

          </p>
        </SpeechBubble>

        <div className="space-y-4">
          <div className="sound-effect text-3xl text-manga-red">NEXT CHAPTER LOADING...</div>
